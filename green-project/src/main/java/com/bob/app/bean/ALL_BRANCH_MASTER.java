...
@Immutable
@Entity
@Table(name="ALL_BRANCH_MASTER")
public class ALL_BRANCH_MASTER {
	...
	public ALL_BRANCH_MASTER() {
		super();
		// TODO Auto-generated constructor stub
	}
	public ALL_BRANCH_MASTER(String brAlpha, String branchName, String brSolid, String zoName, String roName,
	...
	public String toString() {
		return "ALL_BRANCH_MASTER [brAlpha=" + brAlpha + ", branchName=" + branchName + ", brSolid=" + brSolid
